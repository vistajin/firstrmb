...
<body>
	<div class="container nomargin">
		...
		<form action="<?php echo U('Admin/HomeMaint/updateFriendLink');?>" method="post">
			...
			<div class="form-group">
				<label for="text">友情链接名称</label>
				<input type="text" class="form-control" name="text" id="text" value="<?php echo ($record["text"]); ?>" required>
			</div>
			<div class="form-group">
				<label for="url">友情链接URL</label>
				<input type="text" class="form-control" name="url" id="url" value="<?php echo ($record["url"]); ?>" required>
			</div>
			<div align="center">
