...
<body>
    <div class="container nomargin">
        ...
        <form enctype="multipart/form-data" action="/firstrmb/index.php/Admin/SellMaint/updateSellItem" id="addform" method="post">
            ...
            <div class="form-group">
             ...
             <?php if($record["isrecommend"] == 1): ?><input type="checkbox" class="form-control" name="isRecommend" id="isRecommend" data-toggle="toggle" value="1" checked>
             <?php else: ?>
             <input type="checkbox" class="form-control" name="isRecommend" id="isRecommend" data-toggle="toggle" value="1"><?php endif; ?>
            </div>
			<div class="form-group">
...
<!-- 					<option value="">请选择</option> -->
					<?php if(is_array($sellCategoryList)): $i = 0; $__LIST__ = $sellCategoryList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($key == $record['category_uid']): ?><option value="<?php echo ($key); ?>" selected><?php echo ($vo); ?></option>
					<?php else: ?>
<!-- 					<option value="<?php echo ($key); ?>"><?php echo ($vo); ?></option> --><?php endif; endforeach; endif; else: echo "" ;endif; ?>
            ...
            <div class="form-group">
                ...
                <?php if(null == $record['img']): ?><<暂无图片>>
                <?php else: ?>
                <img src="/firstrmb/Uploads/<?php echo ($record["img"]); ?>"><?php endif; ?>
    ...
    <form id="form" action="/firstrmb/index.php/Admin/SellMaint/sellItemList/category_uid/<?php echo ($record["category_uid"]); ?>" method="post"></form>
</body>
<script>
