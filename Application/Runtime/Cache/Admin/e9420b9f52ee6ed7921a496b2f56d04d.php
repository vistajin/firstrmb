...
<body>
	<div class="container">
		<div class="page-header">
			<h3>添加<?php echo ($categoryText); ?></h3>
		</div>
		<form action="<?php echo U('Admin/RichEdit/addRichText');?>" method="post">
			<div class="form-group">
				<label for="title"><?php echo ($categoryText); ?>标题</label> <input type="text" class="form-control" name="title" id="title"
					placeholder="请输入<?php echo ($categoryText); ?>标题">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<!-- 				<input type="text" class="form-control" name="thedate" id="thedate" -->
				<!-- 					placeholder="请输入<?php echo ($categoryText); ?>日期"> -->
				<div class="input-group date form_date" data-date="" data-date-format="yyyy-mm-dd"
					data-link-field="thedate" data-link-format="yyyy-mm-dd" style="width: 200px;">
					<input class="form-control" size="16" type="text" value="" readonly placeholder="请选择日期"> <span class="input-group-addon"><span
	...
	<form id="form" action="/firstrmb/index.php/Admin/RichEdit/getList/category/<?php echo ($category); ?>" method="post"></form>
</body>
<script>
