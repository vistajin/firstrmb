...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1494680067, '1', './data/template/1_1_common_header_home_space.tpl.php', './template/default', 'common/header_home_space')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1494680067, '1', './data/template/1_1_common_header_home_space.tpl.php', './template/default', 'common/header_home_space')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1494680067, '1', './data/template/1_1_common_header_home_space.tpl.php', './template/default', 'common/header_home_space')
;?>
