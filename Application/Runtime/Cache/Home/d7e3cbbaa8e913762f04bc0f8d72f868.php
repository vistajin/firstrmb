 ...
 <div class="w980" id="wrap">
  ...
  <div id="leftBar" class="fl">
   <div id="item">
    ...
    <?php if($activityHover != null): ?><ul> 
          <li><a href="/firstrmb/Home/Activity/activity" <?php echo ($activityItemHover); ?>>公司动态</a></li> 
          <li><a href="/firstrmb/Home/Activity/activity/category/industryNews" <?php echo ($industryNewsItemHover); ?>>行业动态</a></li> 
         </ul><?php endif; ?>
   </div>
   <div id="hot">
 <h2>推荐藏品</h2>
...
<div id="contactus">
 ...
 <?php echo ($contactusSimple); ?>
   ...
   <div id="main" class="fl">
    ...
    <div id="position">
     您的位置：<?php echo ($pageName); ?> <?php echo ($pageName2); ?>
    </div>
    <div id="content">
     <div id="newsList">
      <ul>
       <?php if(is_array($activity)): $i = 0; $__LIST__ = $activity;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><span class="fr"><?php echo ($vo["thedate"]); ?></span> <a class="fl" target="_blank" href="/firstrmb/Home/Activity/detail/uid/<?php echo ($vo["uid"]); ?>"
        title="<?php echo ($vo["title"]); ?>"><?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
      </ul>
     </div>
