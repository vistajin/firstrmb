 ...
 <div class="w980" id="wrap">
  <div id="leftBar" class="fl">
   <div id="item">
    <h2>藏品出售目录</h2>
    <ul>
     <?php if(is_array($sellCategoryList)): $i = 0; $__LIST__ = $sellCategoryList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($category_uid == $vo['uid']): ?><li><a href="/firstrmb/Home/Sell/sell/category_uid/<?php echo ($vo["uid"]); ?>" class='item-hover'><?php echo ($vo["text"]); ?></a></li>
     <?php else: ?>
     <li><a href="/firstrmb/Home/Sell/sell/category_uid/<?php echo ($vo["uid"]); ?>"><?php echo ($vo["text"]); ?></a></li><?php endif; endforeach; endif; else: echo "" ;endif; ?>
    </ul>
   </div>
   <div id="hot">
 <h2>推荐藏品</h2>
...
<div id="contactus">
 ...
 <?php echo ($contactusSimple); ?>
   ...
   <div id="main" class="fl">
    <div id="position">
     您的位置：藏品出售目录 &gt; <span><?php echo ($pageName); ?></span>
    </div>
    <div id="content">
     <div id="sale">
      <ul>
       <?php if(is_array($sellItemList)): $i = 0; $__LIST__ = $sellItemList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="/firstrmb/Home/Sell/detail/uid/<?php echo ($vo["uid"]); ?>" target="_blank" title="<?php echo ($vo["title"]); ?>"> <img
         src="/firstrmb/Uploads/<?php echo ($vo["img"]); ?>" width="222" height="144" alt="" /> <?php echo ($vo["title"]); ?>
