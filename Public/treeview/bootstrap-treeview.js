...
;(function ($, window, document, undefined) {
	...
	var defaults = {
		...
		color: undefined,//'#0000AA',//undefined, // '#000000',
	...
	*/
	...
	Tree.prototype.css = '.treeview .list-group-item{cursor:pointer}.treeview span.indent{margin-left:30px;margin-right:10px}.treeview span.expand-collapse{width:1rem;height:1rem}.treeview span.icon{margin-left:10px;margin-right:5px}'
