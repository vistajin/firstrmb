...
<!--  <input name="header$hidUrl" type="hidden" id="header_hidUrl" value="0" /> -->
 <!-- 内容部分开始 -->
 <div class="w980">
...
<!--     <span>NEWS</span>-->
    ...
    <a href="/firstrmb/Home/Activity/activity">更多>></a>
   </div>
   <marquee id="homeAnnouncement" behavior="scroll" height="180px" onmouseout="this.start()" onmouseover="this.stop()"
...
<!--      <span><?php echo ($vo["thedate"]); ?></span>-->
      <a href="/firstrmb/Home/Activity/detail/uid/<?php echo ($vo["uid"]); ?>" title="<?php echo ($vo["title"]); ?>"><?php echo ($vo["title"]); ?></a>
  ...
  <div id="news2">
   <div id="news-t2">
    ...
    <a href="/firstrmb/Home/Activity/activity/category/industryNews">更多>></a>
   </div>
   <marquee id="homeAnnouncement2" behavior="scroll" height="180px" onmouseout="this.start()" onmouseover="this.stop()"
			direction="up" scrollamount="3">
   <ul>
    <?php if(is_array($industryNews)): $i = 0; $__LIST__ = $industryNews;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
<!--      <span><?php echo ($vo["thedate"]); ?></span>-->
      <a href="/firstrmb/Home/Activity/detail/uid/<?php echo ($vo["uid"]); ?>" title="<?php echo ($vo["title"]); ?>"><?php echo ($vo["title"]); ?></a>
     </li><?php endforeach; endif; else: echo "" ;endif; ?>
   </ul>
...
<!--     <span>COMPANY</span>-->
   ...
   <div class="box"><p></p><br><br>
    <?php echo ($corpbrief); ?>
<!--    <a href="/firstrmb/Home/Aboutus/aboutus/type/corpinfo" class="more"> [查看全文]</a>-->
   </div>
  </div>
...
<!--    <span>CONTACT US</span>-->
   ...
   <div class="box"><?php echo ($contactusSimple); ?>
...
<!--    <a href="/firstrmb/Home/Aboutus/aboutus/type/corpinfo" class="more"> [查看全文]</a>-->
  ...
  <div id="banner">
   ...
   <p>
   <p>
    <font size="3"><?php echo ($buyInfo["title"]); ?></font>
   </p>
   </p>
   <a href="/firstrmb/Home/BuyInfo/detail" title="更多"> 更多>></a>
  </div>
 </div>
 <!-- 内容部分结束 -->
...
<div id="bottom">
 <div class="w980">
  ...
  <div id="bottom-r">
   <p>地址：<?php echo ($basicInfo["address"]); ?> 邮政编ss码：<?php echo ($basicInfo["postal_code"]); ?></p>
   <p>
...
.right {
 ...
 <!-- document.writeln("<a href='https://www.sgs.gov.cn/lz/licenseLink.do?method=licenceView&entyId=dov73ne26zbqpz06h12uvi9nv46w1z06c9'><img  class='right' src='/images/icon.gif' border=0></a>")</SCRIPT> -->
 </form>
</body>
</html>