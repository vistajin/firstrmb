...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1494680086, '1', './data/template/1_1_common_header_forum_guide.tpl.php', './template/default', 'common/header_forum_guide')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1494680086, '1', './data/template/1_1_common_header_forum_guide.tpl.php', './template/default', 'common/header_forum_guide')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1494680086, '1', './data/template/1_1_common_header_forum_guide.tpl.php', './template/default', 'common/header_forum_guide')
;?>
